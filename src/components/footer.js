        ...
        <div className="container">
          <div className="row">
            ...
            <div className="offset-md-2 col-md-4 col">
                ...
                <div className="row">
                  <div className="col my-1"><a className="color-nav" href="mailto:scott@r-p-services.com" target="_blank" rel="noreferrer"><FaEnvelope />  Email: scott@r-p-services.com</a></div>
                </div>
            </div>
            </div>
        </div>
