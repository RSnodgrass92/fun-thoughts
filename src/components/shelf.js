...
render(){
  return(
    ...
    <div className="row">
        <div className={`col-xs-12 col-sm-6 col-md teeshirt mx-0 mx-md-1 p-0 mt-1 ${this.state.cssclasst}`}><Teecard shirt={this.state.shirt1img} description={this.state.shirt1desc} price={this.state.shirt1price}/></div>
        
        <div className={`col-xs-12 col-sm-6 col-md teeshirt mx-0 mx-md-1 p-0 mt-1 ${this.state.cssclasst}`}><Teecard shirt={this.state.shirt2img} description={this.state.shirt2desc} price={this.state.shirt2price}/></div>

        <div className={`col-xs-12 col-sm-6 col-md teeshirt mx-0 mx-md-1 p-0 mt-1 ${this.state.cssclasst}`}><Teecard shirt={this.state.shirt3img} description={this.state.shirt3desc} price={this.state.shirt3price}/></div>

        <div className={`col-xs-12 col-sm-6 col-md teeshirt mx-0 mx-md-1 p-0 mt-1 ${this.state.cssclasst}`}><Teecard shirt={this.state.shirt4img} description={this.state.shirt4desc} price={this.state.shirt4price}/></div>
      </div>
    </div>
  )
  }
